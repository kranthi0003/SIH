...
UPLOAD_FOLDER ='/home/kranthi-kiran/Desktop/app1/uploads/'
...
def convertor(filename):
	pdfFileObj = open('/home/kranthi-kiran/Desktop/app1/uploads/'+filename, 'rb')
	pdfReader = PyPDF2.PdfFileReader(pdfFileObj)
	print("Number of pages:-"+str(pdfReader.numPages))
	num = pdfReader.numPages
	i =0
	file_res = open('/home/kranthi-kiran/Desktop/app1/converts/'+filename.split('.')[0]+'.txt','w',encoding='UTF-8')
	while(i<num):
	...
	if(form1.validate_on_submit() and ('submit' in request.form)):
		if(request.form['submit'] == 'Submit'):
			...
			if file and allowed_file(file.filename):
				...
				author = 'myind4'
				book = open('/home/kranthi-kiran/Desktop/app1/converts/'+filename+'.txt')
				lineNum = 0
				txtNum = 0
				try:
